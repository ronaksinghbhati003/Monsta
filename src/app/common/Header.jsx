       ...
       <Container fluid className="border-bottom d-lg-block d-none">
             <Container className="py-2">
                <div className="d-flex justify-content-between">
                    ...
                    <div className="header-top">
                      <Link href={'/login'} style={{color:'black',textDecoration:'none'}}><span>Login/Register</span></Link>
                    </div>
                </div>
             </Container>
       </Container>
            ...
            <div className="d-flex justify-content-between align-items-center gap-2">
                ...
                <div className="d-flex justify-content-evenly align-items-center gap-3">
                    ...
                    <div className="d-flex align-items-center header-cart gap-2" onClick={()=>setHeaderCart(!headerCart)}>
                        <div className="cart-number d-flex justify-content-center align-items-center">3</div>
                        <div className="pe-2 border-end"><FaShoppingCart/></div>
                        <div className="cart-price d-sm-block d-none">Rs.15800</div>
                    </div>
                </div>
    ...
    <div className="fixed" onClick={()=>setHeaderCart(false)}>
      <div className={`header-cart-menu p-4 ${headerCart?'header-cart-menu-show':" "}`}>
        ...
        <div className="p-3 bg-black">
            <Button className="btn btn-dark w-100 fw-bold">View Cart</Button>
            <Button className="w-100 mt-3 fw-bold" style={{background:'burlywood'}}>View Cart</Button>
        </div>
